...
<div>
    ...
    <ul>
                  ...
                  <li><a href="https://drive.google.com/file/d/1IHQWts84R8heI3vF4pqXLsMGS8cA-A8z/view?usp=sharing" target="_blank"> Resume</a></li>
...
<div>
    ...
    <ul>
          ...
          <div style={{ textAlign: "center",padding:"20px 0px", color:"rgb(61, 59, 59)",backgroundColor:"black"}}>< AiOutlineCopyrightCircle style={{ color:"#f68176"}}/>2022 All rights reserved | Designed by Aaditya Singh</div>
    </section>
  )
}
